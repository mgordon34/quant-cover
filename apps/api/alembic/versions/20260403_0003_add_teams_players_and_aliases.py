...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_players_league_id_source_player_id",
        "players",
        ["league_id", "source_player_id"],
        unique=True,
        postgresql_where=sa.text("source_player_id IS NOT NULL"),
    )
    ...
    op.create_index(
        "ix_player_aliases_source_normalized_alias",
        "player_aliases",
...
def downgrade() -> None:
    op.drop_index("ix_player_aliases_source_normalized_alias", table_name="player_aliases")
    ...
    op.drop_index("ix_players_league_id_source_player_id", table_name="players")
